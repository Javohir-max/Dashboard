...
const buttons = ref([
    {click: imgRotateDec, icon: 'gravity-ui:arrow-rotate-left', w: '25', h: '25'},
    {click: imgRotateInc, icon: 'gravity-ui:arrow-rotate-right', w: '25', h: '25'},
    {click: imgDecrement, icon: 'flowbite:zoom-out-outline', w: '30', h: '30'},
    {click: imgIncrement, icon: 'flowbite:zoom-in-outline', w: '30', h: '30'},
    {click: hide, icon: 'cuida:x-outline', w: '30', h: '30'}
])
</script>
<template>
    <div 
